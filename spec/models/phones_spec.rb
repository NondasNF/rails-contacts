...
RSpec.describe Phone, type: :model do
  ...
  context 'number is empty' do
    it 'return a validation error' do
      ...
      }.to raise_error("Validation failed: Number can't be blank")
    end
  end
  ...
  context 'number is already in the contact database' do
    it 'return a validation error' do
      ...
      }.to raise_error("Validation failed: Number has already been taken")
    end
  end
  ...
  context 'register a Phone to a unexistent contact' do
    it 'return a validation error' do
      ...
      }.to raise_error("Validation failed: Contact must exist")
    end
  end
  ...
  context 'register a Phone with an invalid or blank kind' do
    it 'return a validation error' do
      ...
      }.to raise_error("Validation failed: Kind can't be blank, Kind can't be different from 'house', 'work' and 'other'.")
    end
  end
  ...
  context 'already has a main number in the contact database' do
    it 'return a validation error' do
      ...
      }.to raise_error("Validation failed: Main The contact already has a main number")
    end
  end
end
